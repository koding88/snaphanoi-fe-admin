...
export function AuthCard({ children, className }: AuthCardProps) {
  return (
    <div
      className={cn(
        "surface-enter relative overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,39,0.84),rgba(10,14,23,0.96))] p-6 text-white shadow-[0_24px_100px_rgba(3,7,18,0.36)] ring-1 ring-white/6 backdrop-blur sm:p-7 xl:p-9",
        className,
      )}
    >
