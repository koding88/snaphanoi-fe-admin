  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[--color-canvas] text-white">
      ...
      <div className="relative mx-auto grid min-h-screen max-w-[1600px] grid-cols-1 px-4 py-4 lg:px-6 xl:grid-cols-[1.1fr_0.9fr] xl:px-8 xl:py-8">
        <section className="surface-enter flex min-h-[24rem] flex-col justify-between rounded-[2.25rem] border border-white/8 bg-white/5 p-6 shadow-[0_30px_120px_rgba(0,0,0,0.28)] backdrop-blur md:p-8 xl:mr-5 xl:min-h-full xl:p-12">
          ...
          <div className="stagger-fade grid gap-4 text-sm text-white/72 md:grid-cols-3">
            ...
            <div className="surface-float rounded-2xl border border-white/8 bg-white/6 p-4">
              Session bootstrap aligned to backend semantics
            </div>
            <div className="surface-float rounded-2xl border border-white/8 bg-white/6 p-4">
