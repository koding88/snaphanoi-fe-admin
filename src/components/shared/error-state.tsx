...
export function ErrorState({ title, description, action }: ErrorStateProps) {
  return (
    <div className="rounded-[2rem] border border-destructive/20 bg-[linear-gradient(180deg,rgba(255,245,245,0.92),rgba(255,236,236,0.84))] px-8 py-14 text-center shadow-soft">
