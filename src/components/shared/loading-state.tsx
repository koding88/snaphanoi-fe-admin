...
export function LoadingState({
  ...
  return (
    <div className="flex min-h-56 flex-col items-center justify-center gap-5 rounded-[2rem] border border-border/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(247,243,236,0.92))] px-6 py-12 text-center shadow-soft">
