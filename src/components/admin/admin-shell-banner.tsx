...
export function AdminShellBanner() {
  return (
    <div className="grid gap-4 lg:grid-cols-[1.45fr_0.95fr]">
      <section className="relative overflow-hidden rounded-[2.25rem] border border-slate-900/10 bg-[linear-gradient(135deg,rgba(18,25,36,0.98),rgba(12,18,30,0.96),rgba(48,38,26,0.9))] px-6 py-7 text-white shadow-[0_28px_90px_rgba(15,23,42,0.24)] md:px-8 md:py-8">
        ...
        <div className="relative space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm leading-7 text-white/74 md:text-base">
              Layout rhythm, navigation hierarchy, and placeholder surfaces are ready for real user
              and role workflows to land cleanly in the next stages.
            </p>
          </div>
        </div>
      </section>
      <section className="rounded-[2.25rem] border border-border/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,244,237,0.88))] p-6 shadow-soft md:p-7">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Users and roles pages intentionally stop at navigable placeholder surfaces. No CRUD
              behavior has been started here.
            </p>
          </div>
        </div>
      </section>
