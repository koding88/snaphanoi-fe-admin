  ...
  return (
    <AdminPageContainer tone="hero" className="space-y-8 pb-10">
      <PageHeader
        ...
        description="Shape single-language blog stories, maintain pinned visibility, and keep covers and content ready for published surfaces."
        meta={
