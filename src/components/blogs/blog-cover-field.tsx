        ...
        {previewUrl ? (
          <div className="p-4">
            <ProjectCoverPreview
              ...
              className="rounded-[1.45rem] border-border/70 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.94),rgba(233,227,217,0.9))] shadow-[0_24px_54px_-36px_rgba(19,17,14,0.42)]"
